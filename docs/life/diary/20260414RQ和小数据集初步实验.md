...
## lite数据集
![alt text](assets/20260414RQ和小数据集初步实验/image.png)
...
{
  "n_instances": 37,
  "mini_no_stress_status_counts": {
    "apply_patch_failed": 3,
    "correctness_failed": 5,
    "correctness_timed_out": 1,
    "missing_result": 15,
    "passed": 13
  },
  "mini_status_counts": {
    "apply_patch_failed": 2,
    "correctness_exit_code": 3,
  ...
  "speedup_comparison": {
    "comparable_count": 37,
    "mini_better": 11,
    "mini_no_stress_better": 26,
    "equal": 15,
    "mini_no_stress_harmonic_mean": 1.3249580882578265,
    "mini_harmonic_mean": 1.5038350532350964
  }
}
```
...
run_hotspots_query_stress VS min-swe-agent



## RQ4， 消融
**gpt-5.4mini 为什么提升这么小呢？**
baseline:
  harmonic mean: 0.044270564235432616

plugin section1：hybrid time的hotspots
  harmonic mean: 0.047760955456071716

plugin section2：profiler tree
  harmonic mean: 0.05341460573464667

问题出在哪里呢？
拥有了这两个工具后，gpt5.4 mini还是没办法找到edit func


plugin section3：stress暴露的hotspots以及porfiler tree的路径

## RQ5，edit func命中率、cost、case study等

还是先别jaccard，就命中就行：
**命中率就是有提升啊**
Top-1, Total: 30, Hit: 4, Hit rate: 0.1333
Output: logs/edit_func_analysis/edit_func_oracle.json

Top-1, Total: 35, Hit: 15, Hit rate: 0.4286
Output: logs/edit_func_analysis/edit_func_hotspots.json

Top-1, Total: 37, Hit: 13, Hit rate: 0.3514
Output: logs/edit_func_analysis/edit_func_hotspots_query.json
