...
![image-20241205194316833](/assets/legacy-picture/image-20241205194316833.png)
...
![image-20241205200457077](/assets/legacy-picture/image-20241205200457077.png)
...
![image-20241205194635144](/assets/legacy-picture/image-20241205194635144.png)

![image-20241205194644338](/assets/legacy-picture/image-20241205194644338.png)

![image-20241205194651031](/assets/legacy-picture/image-20241205194651031.png)

![image-20241205194659224](/assets/legacy-picture/image-20241205194659224.png)
...
![image-20241205194754244](/assets/legacy-picture/image-20241205194754244.png)
...
![image-20241205194841571](/assets/legacy-picture/image-20241205194841571.png)

![image-20241205194935721](/assets/legacy-picture/image-20241205194935721.png)
...
![image-20241205195541179](/assets/legacy-picture/image-20241205195541179.png)
...
![image-20241205195736428](/assets/legacy-picture/image-20241205195736428.png)
...
![image-20241205195816011](/assets/legacy-picture/image-20241205195816011.png)
...
![image-20241205200227114](/assets/legacy-picture/image-20241205200227114.png)



eg:

![image-20241205200155435](/assets/legacy-picture/image-20241205200155435.png)

![image-20241205200213403](/assets/legacy-picture/image-20241205200213403.png)
...
![image-20241205200754063](/assets/legacy-picture/image-20241205200754063.png)
...
![image-20241205201238859](/assets/legacy-picture/image-20241205201238859.png)
...
![image-20241205201449534](/assets/legacy-picture/image-20241205201449534.png)
...
![image-20241205202144216](/assets/legacy-picture/image-20241205202144216.png)
...
![image-20241205202458148](/assets/legacy-picture/image-20241205202458148.png)
...
![image-20241205202702159](/assets/legacy-picture/image-20241205202702159.png)
...
![image-20241205203256439](/assets/legacy-picture/image-20241205203256439.png)
...
![image-20241205203850974](/assets/legacy-picture/image-20241205203850974.png)
...
![image-20241205204401227](/assets/legacy-picture/image-20241205204401227.png)



磁盘是以“<font color='red'>盘面—磁道—扇区</font>”的方式来进行数据组织

![image-20241205204415494](/assets/legacy-picture/image-20241205204415494.png)
...
> ![image-20241205205121700](/assets/legacy-picture/image-20241205205121700.png)
...
![image-20241205204816632](/assets/legacy-picture/image-20241205204816632.png)
...
![image-20241207202054607](/assets/legacy-picture/image-20241207202054607.png)
...
![image-20241207200746860](/assets/legacy-picture/image-20241207200746860.png)

![image-20241207200831463](/assets/legacy-picture/image-20241207200831463.png)
...
![image-20241207200904338](/assets/legacy-picture/image-20241207200904338.png)

![image-20241207200913090](/assets/legacy-picture/image-20241207200913090.png)

![image-20241207200918806](/assets/legacy-picture/image-20241207200918806.png)

2. 存储管理主要是针对计算机系统的重要资源——主存储器的管理，也就是内存进行管理

   存储管理的主要任务是：对多道程序<font color='red'>分配存储空间</font>，并为其运行提供良好的环境，提高内存利用率并方便用户使用。

![image-20241207201028583](/assets/legacy-picture/image-20241207201028583.png)
...
![image-20241207201040293](/assets/legacy-picture/image-20241207201040293.png)

![image-20241207201123674](/assets/legacy-picture/image-20241207201123674.png)

![image-20241207201051922](/assets/legacy-picture/image-20241207201051922.png)

![image-20241207201100415](/assets/legacy-picture/image-20241207201100415.png)



4. 设备管理的主要任务是为系统中的进程分配设备，完成进程对I/O的请求，并提高设备的利用率

![image-20241207201152088](/assets/legacy-picture/image-20241207201152088.png)



![image-20241207201248232](/assets/legacy-picture/image-20241207201248232.png)
...
![image-20241207200400064](/assets/legacy-picture/image-20241207200400064.png)
...
![image-20241207200512514](/assets/legacy-picture/image-20241207200512514.png)
...
> 从文件、到专用数据库软件
>
> ![image-20241207201548480](/assets/legacy-picture/image-20241207201548480.png)
>
> ![image-20241207201622329](/assets/legacy-picture/image-20241207201622329.png)



目前常用的数据库管理系统有Microsoft Office Access、Visual FoxPro、SQL Server、Oracle、DB2和MySQL等。

![image-20241207201757378](/assets/legacy-picture/image-20241207201757378.png)

![image-20241207201808498](/assets/legacy-picture/image-20241207201808498.png)
...
1. 结构化程序设计语言
   ...
   ![image-20241207204416810](/assets/legacy-picture/image-20241207204416810.png)
...
![image-20241207203736159](/assets/legacy-picture/image-20241207203736159.png)
...
![image-20241207203801215](/assets/legacy-picture/image-20241207203801215.png)
...
![image-20241207211132226](/assets/legacy-picture/image-20241207211132226.png)

> 逻辑结构
> 数据元素之间的逻辑关系,与数据在计算机中的存储方式无关，
> 数据的逻辑结构分为线性结构、树形结构和网状结构

![image-20241207210210401](/assets/legacy-picture/image-20241207210210401.png)

> 逻辑结构
> 数据的逻辑结构在计算机存储器上的实现，即数据在计算机中是如何存储的
>
> 其中<font color='red'>顺序存储</font>结构和<font color='red'>链式存储</font>结构是最常用的两种存储方式。
> ![image-20241207211153331](/assets/legacy-picture/image-20241207211153331.png)
> ![image-20241207211203519](/assets/legacy-picture/image-20241207211203519.png)
...
![](/assets/legacy-picture/image-20241207211110684.png)
...
![image-20241207211324542](/assets/legacy-picture/image-20241207211324542.png)

![image-20241207211340732](/assets/legacy-picture/image-20241207211340732.png)
...
![image-20241207211443083](/assets/legacy-picture/image-20241207211443083.png)
...
![image-20241207211553043](/assets/legacy-picture/image-20241207211553043.png)
...
![image-20241207211711009](/assets/legacy-picture/image-20241207211711009.png)
...
![image-20241207211746271](/assets/legacy-picture/image-20241207211746271.png)


![image-20241207211819834](/assets/legacy-picture/image-20241207211819834.png)

> 不论是树还是图、深度优先遍历与广度优先遍历
> 

![image-20241207211906884](/assets/legacy-picture/image-20241207211906884.png)

![image-20241207211916207](/assets/legacy-picture/image-20241207211916207.png)

![image-20241207211921556](/assets/legacy-picture/image-20241207211921556.png)

![image-20241207211927332](/assets/legacy-picture/image-20241207211927332.png)
...
![image-20241207213525878](/assets/legacy-picture/image-20241207213525878.png)
...
![image-20241207213619173](/assets/legacy-picture/image-20241207213619173.png)
...
![image-20241207213710649](/assets/legacy-picture/image-20241207213710649.png)

网状数据模型：用记录类型为结点的网状结构来表示实体与实体间联系的模型

![image-20241207213728185](/assets/legacy-picture/image-20241207213728185.png)
...
> ![image-20241207213844805](/assets/legacy-picture/image-20241207213844805.png)
>
...
![image-20241207214439269](/assets/legacy-picture/image-20241207214439269.png)
...
![image-20241207214530432](/assets/legacy-picture/image-20241207214530432.png)
...
![image-20241207222443273](/assets/legacy-picture/image-20241207222443273.png)
...
2. 增量模型
   ...
   ![image-20241207222534563](/assets/legacy-picture/image-20241207222534563.png)

3.  螺旋模型
   螺旋模型，<font color='green'>可以看作瀑布模型和增量模型的结合</font>。它像螺旋一样不断迭代，又像螺旋一样不断前进，即每次迭代都不是在原有水平上进行的
   ![image-20241207222620413](/assets/legacy-picture/image-20241207222620413.png)
...
![image-20241207222721354](/assets/legacy-picture/image-20241207222721354.png)
...
![img](/assets/legacy-picture/resize%2Cm_lfit%2Climit_1%2Ch_1080.png)
...
![image-20241207223234012](/assets/legacy-picture/image-20241207223234012.png)
...
![image-20241207224347356](/assets/legacy-picture/image-20241207224347356.png)
