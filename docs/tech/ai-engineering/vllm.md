...
![alt text](/assets/research/llm-agent/vllm%E9%83%A8%E7%BD%B2deepseek/image.png)
...
成功
![alt text](/assets/research/llm-agent/vllm%E9%83%A8%E7%BD%B2deepseek/image-1.png)

使用nvidia-smi查看显存，占用很大，应该是vllm做了显存的页式管理？
![alt text](/assets/research/llm-agent/vllm%E9%83%A8%E7%BD%B2deepseek/image-2.png)

下面是单卡启动的显存图示
![alt text](/assets/research/llm-agent/vllm%E9%83%A8%E7%BD%B2deepseek/image-3.png)
...
同样成功调用
![alt text](/assets/research/llm-agent/vllm%E9%83%A8%E7%BD%B2deepseek/image-4.png)
...
![alt text](/assets/research/llm-agent/vllm%E9%83%A8%E7%BD%B2deepseek/image-5.png)
...
![alt text](/assets/research/llm-agent/vllm%E9%83%A8%E7%BD%B2deepseek/image-6.png)
...
也成功调用
![alt text](/assets/research/llm-agent/vllm%E9%83%A8%E7%BD%B2deepseek/image-7.png)
...
报错，显存不够
![alt text](/assets/research/llm-agent/vllm%E9%83%A8%E7%BD%B2deepseek/image-8.png)
下图为llama3的70b的架构，llama3.3的不知道
![alt text](/assets/research/llm-agent/vllm%E9%83%A8%E7%BD%B2deepseek/image-9.png)
...
> 如下图
> ![alt text](/assets/research/llm-agent/vllm%E9%83%A8%E7%BD%B2deepseek/image-10.png)
...
成功调用，但延时略高
![alt text](/assets/research/llm-agent/vllm%E9%83%A8%E7%BD%B2deepseek/image-11.png)
...
![alt text](/assets/research/llm-agent/vllm%E9%83%A8%E7%BD%B2deepseek/image-13.png)
再如下图是处理时的显存情况
![alt text](/assets/research/llm-agent/vllm%E9%83%A8%E7%BD%B2deepseek/image-12.png)
...
![alt text](/assets/research/llm-agent/vllm%E9%83%A8%E7%BD%B2deepseek/image-14.png)
...
同样成功启动如下图
![alt text](/assets/research/llm-agent/vllm%E9%83%A8%E7%BD%B2deepseek/image-15.png)
处理token时，显存显示如下
![alt text](/assets/research/llm-agent/vllm%E9%83%A8%E7%BD%B2deepseek/image-16.png)

> 暂且做到这里，然后开始做agent

* 当刚开始启动时，发现显存占用为 35G * 4 =140G，也就是说，只需要启动模型参数，然后框架自身， 最后根据cpu利用率其自动调整分页方式，管理推理时显存
  ![alt text](/assets/research/llm-agent/vllm%E9%83%A8%E7%BD%B2deepseek/image-18.png)
