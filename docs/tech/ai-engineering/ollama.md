...
![1741742472526](/assets/research/llm-agent/image/ollama/1741742472526.png)
此时，将自动pull下模型参数，并运行

如果直接用ollama run qwq的话，将开启一个对话框进行对话，
![1741743280489](/assets/research/llm-agent/image/ollama/1741743280489.png)
...
![1741743220227](/assets/research/llm-agent/image/ollama/1741743220227.png)
