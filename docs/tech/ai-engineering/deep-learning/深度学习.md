...
$\begin{aligned}H(X)&=E_{x\in X}[I(x)]\newline&=E_{x\in X}[-logP(x)]\newline&=-\sum P(x)logP(x)\end{aligned}$
 ...
 ![image-20241216211232527](/assets/legacy-picture/image-20241216211232527.png)
...
![image-20241216212803152](/assets/legacy-picture/image-20241216212803152.png)
...
![image-20241216214141042](/assets/legacy-picture/image-20241216214141042.png)



应用到机器学习

![image-20241217120606719](/assets/legacy-picture/image-20241217120606719.png)
...
![image-20241216201438721](/assets/legacy-picture/image-20241216201438721.png)

CIFAR-10有6万张32*32色彩图像，共10类，每类6000张



![image-20241216201507923](/assets/legacy-picture/image-20241216201507923.png)
...
![image-20241216202708925](/assets/legacy-picture/image-20241216202708925.png)

文档归类，将文档分为运动类的、技术类的，等等

![image-20241216202844256](/assets/legacy-picture/image-20241216202844256.png)

情感分类，积极的，消极的，比如查看影评、书评是正面的、负面的

![image-20241216202914029](/assets/legacy-picture/image-20241216202914029.png)
...
![image-20241216203931480](/assets/legacy-picture/image-20241216203931480.png)

![image-20241216203956662](/assets/legacy-picture/image-20241216203956662.png)
...
![image-20241216204640753](/assets/legacy-picture/image-20241216204640753.png)
...
![image-20241217120948216](/assets/legacy-picture/image-20241217120948216.png)

有一个线性函数，f(x,W)，一个决策函数g

<font color='red'>***这里如果g如图中所取值的话，其导数就都为0，导致无法进行梯度下降等。使用sigmoid函数即$\sigma(x)=\frac{1}{1+e^{-x}}$，可以解决这个问题：***</font>

![image-20241217121225793](/assets/legacy-picture/image-20241217121225793.png)

接下来以二分类问题为例子：

![image-20241217121404263](/assets/legacy-picture/image-20241217121404263.png)

![image-20241217122450564](/assets/legacy-picture/image-20241217122450564.png)
...
![image-20241217121952525](/assets/legacy-picture/image-20241217121952525.png)
...
![image-20241217122725966](/assets/legacy-picture/image-20241217122725966.png)
...
![image-20241217123252202](/assets/legacy-picture/image-20241217123252202.png)

与二分类问题的不同之处在于，判别函数g用了C个，求解出是该类别归属于所有c个中的最大概率的下标

![image-20241217123516539](/assets/legacy-picture/image-20241217123516539.png)
...
![image-20241217125850294](/assets/legacy-picture/image-20241217125850294.png)
...
![image-20241217130206822](/assets/legacy-picture/image-20241217130206822.png)
...
![image-20241217130445372](/assets/legacy-picture/image-20241217130445372.png)

![image-20241217130506145](/assets/legacy-picture/image-20241217130506145.png)
...
![image-20241217130551134](/assets/legacy-picture/image-20241217130551134.png)

![image-20241217130603414](/assets/legacy-picture/image-20241217130603414.png)
...
![image-20241217140645801](/assets/legacy-picture/image-20241217140645801.png)

![image-20241217140734423](/assets/legacy-picture/image-20241217140734423.png)



#### ELU

![image-20241217140750155](/assets/legacy-picture/image-20241217140750155.png)



![image-20241217140815606](/assets/legacy-picture/image-20241217140815606.png)

![image-20241217140821877](/assets/legacy-picture/image-20241217140821877.png)

ELU 的提出也解决了 ReLU 的问题。与 ReLU 相比，ELU 有负值，这会使<font color='red'>***激活的平均值接近零***</font>，让模型学习得更快。



![image-20241217140853087](/assets/legacy-picture/image-20241217140853087.png)

#### GLU

GLU(Gated Linear Units,门控线性单元)引入了两个不同的线性层，其中一个首先经过sigmoid函数，其结果将和另一个线性层的输出进行逐元素相乘作为最终的输出：

![image-20241217141124966](/assets/legacy-picture/image-20241217141124966.png)
...
![image-20241217143327127](/assets/legacy-picture/image-20241217143327127.png)
...
![image-20241217141233487](/assets/legacy-picture/image-20241217141233487.png)
...
![image-20241217141357129](/assets/legacy-picture/image-20241217141357129.png)
...
![image-20250405225253349](/assets/legacy-picture/image-20250405225253349.png)



![image-20250405225342623](/assets/legacy-picture/image-20250405225342623.png)
