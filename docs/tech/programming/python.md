...
> 请注意，可变 具有很微妙的含义
![alt text](/assets/tech/code-assets/python/image.png)

不可变对象的修改，会创建新的对象
int类型为不可变对象
![alt text](/assets/tech/code-assets/python/image-1.png)
str类型同样为不可变对象， 可以对其索引但不可以修改
![alt text](/assets/tech/code-assets/python/image-2.png)


可变对象的修改 不会创建 新的对象
list的可变性，
![alt text](/assets/tech/code-assets/python/image-4.png)
set是可变对象，set存储的元素是不可变对象
![alt text](/assets/tech/code-assets/python/image-3.png)
...
![image-20250110202903440](/assets/legacy-picture/image-20250110202903440.png)
...
##### await存在的不足
>![1741765104630](/assets/tech/code-image/python/1741765104630.png)
> 如上图，由于等待机制
> 仍然执行3秒钟
...
![1741765215547](/assets/tech/code-image/python/1741765215547.png)
如上图，此时就只执行了2秒
...
![1741765625470](/assets/tech/code-image/python/1741765625470.png)
...
![image-20241202184637758](/assets/legacy-picture/image-20241202184637758.png)
