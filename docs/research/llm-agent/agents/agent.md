...
![alt text](/assets/research/llm-agent/agent/image-1.png)
![alt text](/assets/research/llm-agent/agent/image-2.png)


![alt text](/assets/research/llm-agent/agent/image-3.png)
...
![提示词万能公式](/assets/research/llm-agent/agent/image-4.png)

#### prompt方法
为此，大家也发展了各种各样的Prompt工程的玩法，如**角色扮演、零样本提示和少样本提示**。  
比如一个澳大利亚少年编写了一个15000个字符的提示词，成功地让他变身为人类的导师，教授各种知识。
![prompt的方式](/assets/research/llm-agent/agent/image-5.png)  


https://github.com/JushBJJ/Mr.-Ranedeer-AI-Tutor  
![Ranedeer AI Tutor](/assets/research/llm-agent/agent/image-6.png)  
...
![alt text](/assets/research/llm-agent/agent/image-7.png)
...
![COT](/assets/research/llm-agent/agent/image-10.png)

![CoT-SC self consistency](/assets/research/llm-agent/agent/image-11.png)
...
![TOT](/assets/research/llm-agent/agent/image-13.png)
...
![GOT](/assets/research/llm-agent/agent/image-12.png)


#### CR
cumulative reasoning

![CR](/assets/research/llm-agent/agent/image-14.png)
...
![ReACT](/assets/research/llm-agent/agent/image-15.png)
#### Reflexion
这样仍然不够，我们希望**大模型在完成每一个任务后，能够积累经验**，故而产生了借鉴强化学习思路的"反射"机制。  
反射机制能够让机器**记住每一次任务的完成情况，无论效果好坏，以供未来参考，提升模型的性能**。  


![Reflexion](/assets/research/llm-agent/agent/image-16.png)


### Agent
24.4月，**AutoGPT**横空出世，短短数周Star数就超过PyTorch达到90k，赚足了眼球。

![alt text](/assets/research/llm-agent/agent/image-17.png)
下图是AutoGPT 发布的进行中的架构图，旨在实现对任务的有效管理。生成的任务将会被加入优先级队列中，随后系统会不断从优先队列中选择优先级最高的任务进行执行，整个过程中，任何反馈都会通过记忆进行迭代优化代码。
![alt text](/assets/research/llm-agent/agent/image-18.png)

![alt text](/assets/research/llm-agent/agent/image-19.png)


### Multi-Agent

#### 斯坦福小镇
![alt text](/assets/research/llm-agent/agent/image-20.png)
...
![alt text](/assets/research/llm-agent/agent/image-21.png)
...
```
![alt text](/assets/research/llm-agent/agent/image-22.png)
...
```
![alt text](/assets/research/llm-agent/agent/image-23.png)
...
最终启动后的图如下：
![alt text](/assets/research/llm-agent/agent/image-25.png)
...
![alt text](/assets/research/llm-agent/agent/image-26.png)
![alt text](/assets/research/llm-agent/agent/image-27.png)
![alt text](/assets/research/llm-agent/agent/image-24.png)
