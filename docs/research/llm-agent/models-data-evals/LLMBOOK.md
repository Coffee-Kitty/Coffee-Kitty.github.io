...
![image-20241214150916399](/assets/legacy-picture/image-20241214150916399.png)



如何加入位置编码？

![image-20241214151427242](/assets/legacy-picture/image-20241214151427242.png)





![image-20241214151538245](/assets/legacy-picture/image-20241214151538245.png)





![image-20241214152626168](/assets/legacy-picture/image-20241214152626168.png)
...
![image-20241222140408636](/assets/legacy-picture/image-20241222140408636.png)

> NVIDIA GPU 中的内存(显存)按照它们物理上是在 GPU 芯片内部还是板卡 RAM 存储芯片上,决定了它们的速度、大小以及访问限制。
> <img src="/assets/legacy-picture/image-20241222140617957.png" alt="image-20241222140617957" style="zoom:50%;" />
>
...
> <img src="/assets/legacy-picture/image-20241222141533028.png" alt="image-20241222141533028" style="zoom:50%;" />
...
![image-20241222141624499](/assets/legacy-picture/image-20241222141624499.png)



首先忽略softmax操作，简单认为 $Q \times K^T$之后直接跟V乘，得到O，如下图

![image-20241222142058385](/assets/legacy-picture/image-20241222142058385.png)

> ![image-20241222142328126](/assets/legacy-picture/image-20241222142328126.png)
>
> ![image-20241222142343629](/assets/legacy-picture/image-20241222142343629.png)
>
> ![image-20241222142519326](/assets/legacy-picture/image-20241222142519326.png)
>
> 所以目前最大的问题，在于添加了softmax操作后如何进行以上过程

![image-20241222143539349](/assets/legacy-picture/image-20241222143539349.png)

 目前，训练都是混合精度FP16，由此引进 safe_max

![image-20241222143845751](/assets/legacy-picture/image-20241222143845751.png)

> 实现softmax的分块！！！
>
> ![image-20241222144222319](/assets/legacy-picture/image-20241222144222319.png)



![image-20241222144721955](/assets/legacy-picture/image-20241222144721955.png)

![image-20241222144818944](/assets/legacy-picture/image-20241222144818944.png)
...
![image-20241222144947602](/assets/legacy-picture/image-20241222144947602.png)
...
![image-20241211220513952](/assets/legacy-picture/image-20241211220513952.png)
...
![image-20241211222432116](/assets/legacy-picture/image-20241211222432116.png)
...
​	![image-20241212155809344](/assets/legacy-picture/image-20241212155809344.png)
...
* 对比式。对比式训练方法一定程度上能够克服打分式训练方法的不足。<font color='green'>针对一个问题输入,人类标注者仅需对两条相应输出进行排序,排序在前的输出被视为正例(更符合人类偏好),另一条输出则被视为负例。</font>这种标注方式不仅降低了标注难度,还提高了不同标注者之间的一致性。在学习过程中,通常会采用对比学习的方法对奖励模型进行训练。<font color='red'>奖励模型需要学习在提升正例分数的同时,进  一步降低负例的分数,以最大化正例和负例之间的分数差异。</font>下式展示了一个简  化版的对比式训练方法的损失函数:
  ...
  ![image-20241212160018531](/assets/legacy-picture/image-20241212160018531.png)

![image-20241212160849466](/assets/legacy-picture/image-20241212160849466.png)

> 小细节
> given the input x， 正例输出Y+ ，负例输出Y-,
> 将x 和 Y+、Y-分别拼接，输入获取得分值，然后计算两者之间差异。
>
> ![image-20241212162300940](/assets/legacy-picture/image-20241212162300940.png)
> 

* 排序式：

![image-20241212161001849](/assets/legacy-picture/image-20241212161001849.png)
...
![image-20241212163357253](/assets/legacy-picture/image-20241212163357253.png)
...
​	![image-20241212163852262](/assets/legacy-picture/image-20241212163852262.png)
...
![image-20241212164113847](/assets/legacy-picture/image-20241212164113847.png)

![image-20241212164133893](/assets/legacy-picture/image-20241212164133893.png)

![image-20241212164144679](/assets/legacy-picture/image-20241212164144679.png)

![image-20241212164150559](/assets/legacy-picture/image-20241212164150559.png)
...
>
> ![image-20241217204735490](/assets/legacy-picture/image-20241217204735490.png)
...
>
> ![image-20241217204856460](/assets/legacy-picture/image-20241217204856460.png)
...
![image-20241217205512549](/assets/legacy-picture/image-20241217205512549.png)
...
![image-20241217205329359](/assets/legacy-picture/image-20241217205329359.png)
...
![image-20241218141548945](/assets/legacy-picture/image-20241218141548945.png)

混淆矩阵：

​	![image-20241218120853495](/assets/legacy-picture/image-20241218120853495.png)
...
![image-20241218142537164](/assets/legacy-picture/image-20241218142537164.png)

$F_\beta$指标

![image-20241218142644645](/assets/legacy-picture/image-20241218142644645.png)
...
5. PR曲线(PR Curve):
   ...
   ![image-20241218121843300](/assets/legacy-picture/image-20241218121843300.png)
...
> ![image-20241218143204732](/assets/legacy-picture/image-20241218143204732.png)
>
...
> 
>
> ![image-20241218145132462](/assets/legacy-picture/image-20241218145132462.png)
> ![image-20241218145126179](/assets/legacy-picture/image-20241218145126179.png)
...
![image-20241218145808857](/assets/legacy-picture/image-20241218145808857.png)

![image-20241218145903811](/assets/legacy-picture/image-20241218145903811.png)
...
![image-20241218145944094](/assets/legacy-picture/image-20241218145944094.png)
...
![image-20241218150522090](/assets/legacy-picture/image-20241218150522090.png)



![image-20241218152351424](/assets/legacy-picture/image-20241218152351424.png)



困惑度的计算可以视为模型分配给测试集中每一个词汇的概率的几何平均值的倒数,它和交叉熵的关系为:

![image-20241218152427899](/assets/legacy-picture/image-20241218152427899.png)
...
![image-20241218153603624](/assets/legacy-picture/image-20241218153603624.png)
...
![image-20241218154043351](/assets/legacy-picture/image-20241218154043351.png)
